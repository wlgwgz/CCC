========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : DMS
========================================================================


AppWizard has created this DMS application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your DMS application.
...
res\DMS.ico
    ...
    icon is included by the main resource file DMS.rc.
...
DMSDlg.h, DMSDlg.cpp - the dialog
    These files contain your CDMSDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in DMS.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CDMSDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named DMS.pch and a precompiled types file named StdAfx.obj.
